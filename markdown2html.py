    ...
    with open(sys.argv[1]) as read:
        with open(sys.argv[2], "w") as html:
            ...
            for line in read:
                ...
                if md5:
                    line = line.replace(
                        md5[0], hashlib.md5(md5_inside[0].encode()).hexdigest())
                ...
                if remove_letter_c:
                    ...
                    line = line.replace(remove_letter_c[0],
                    remove_c_more)
                ...
                if 1 <= heading_num <= 6:
                    line = '<h{}>'.format(
                        heading_num) + headings.strip() + '</h{}>'.format(heading_num)
